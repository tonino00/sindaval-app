...
const Checkout = () => {
  ...
  const handleCheckout = async () => {
    ...
    try {
      const response = await api.post(
        "/payments/checkout",
        buildCheckoutPayload(paymentMethod)
      );
  ...
  const handleSelectPaymentMethod = async (nextMethod) => {
    ...
    try {
      const response = await api.post(
        "/payments/checkout",
        buildCheckoutPayload(nextMethod)
      );
          ...
          <div style={styles.paymentCard}>
            ...
            <div style={styles.securityInfo}>
              ...
              <div style={styles.securityText}>
                ...
                <p>
                  Processado pelo Mercado Pago. Seus dados nunca são armazenados
            ...
            <p style={styles.disclaimer}>
              Ao clicar em "Prosseguir para Pagamento", você será redirecionado
              para o ambiente seguro do Mercado Pago.
            </p>
          </div>
        </div>
      </div>
